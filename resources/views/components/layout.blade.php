    ...
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        <div
            ...
            <div
                ...
                <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">Lorem
                    ipsum dolor sit amet.</h1>
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Lorem ipsum dolor sit, amet
                    consectetur adipisicing elit. Doloremque, reiciendis!</p>
                <a href="/products"
